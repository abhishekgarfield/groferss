...
import com.upgrad.FoodOrderingApp.service.entity.CustomerAuthService;
...
public class CustomerController {
    ...
    public ResponseEntity<LoginResponse> login(@RequestHeader("authorization")  final String authorization)
        ...
        CustomerAuthService customerAuthToken = customerService.authenticate(decodedArray[0] , decodedArray[1]);
    ...
    public ResponseEntity<LogoutResponse>logout(@RequestHeader("authorization") final String authorization)
        ...
        final CustomerAuthService CustomerAuthService = customerService.logout(bearerToken[1]);

        // Gets the details of the customer based on received access token
        CustomerEntity customerEntity = CustomerAuthService.getCustomer();
